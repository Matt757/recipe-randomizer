$(document).ready(function() {
    $("#getRecipe").click(function () {
        ...
        (async () => {
            const rawResponse = await fetch('http://localhost:8080/api/randomRecipe', {
                method: 'POST',
                headers: {
        ...
        //         console.log(data);
        //         console.log("de");
        //         let tableHead = recipe.find("thead");
        //         let tableBody = recipe.find("tbody");
        //         tableHead.append("");
        //         tableBody.append("");
        ...
        //         }
        //         else {
        //             $("#getDifferentSideDish").css("display", "block");
        //             let name = data.mainCourseDto.name;
        //             let notes = data.mainCourseDto.notes;
        //             let numberOfDays = data.mainCourseDto.numberOfDays;
        //             let lastCooked = data.mainCourseDto.lastCooked;
        ...
        //         }
        //         $("#getFirstCourse").css("display", "block");
        //         console.log("display");
        //         $("#updateRecipes").css("display", "block");
        //     })
        //     .catch(error => {
    ...
    $("#getFirstCourse").click(function () {
        ...
        fetch('http://localhost:8080/api/firstCourse/' + firstCourseId.valueOf(), {
            ...
            .then(response => response.json())
            .then(data => {
                let tableHead = firstCourse.find("thead");
                let tableBody = firstCourse.find("tbody");
                tableHead.append("");
                tableBody.append("");
                let name = data.name;
